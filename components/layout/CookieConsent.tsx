...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity duration-300">
      <div className="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-4/5 rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-[320px] animate-[fadeInScale_0.25s_ease-out]">
  <div className="flex flex-col items-center pt-9 px-6 pb-6 relative">
    ...
    <h5 className="w-full text-sm font-semibold text-zinc-700 mb-2">
      Ваша конфиденциальность важна для нас
    </h5>

    <p className="w-full text-sm text-zinc-600 leading-relaxed mb-6">
